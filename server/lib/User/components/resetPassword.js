const getResetPasswordComponent = (url) => {
    return (
        `
                            ...
                            <tbody>
                                <tr style="border-collapse:collapse;">
                                    <td style="padding:20px;margin:0">
                                        <p style="font-size: 24px; font-weight: 600;">You changed your password</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr style="border-collapse:collapse;">
                    <td align="center" style="margin:0;padding-left:10px;padding-right:10px;padding-bottom:15px;padding-top:20px">
                        <span style="border-style:solid;border-width:0px;display:inline-block;width:auto">
                            <a href="${url}/signup" style="text-decoration:none;color:#ffffff;font-size:14px;font-weight: 500;border-style:solid;border-color:#2230F6;border-width:8px 50px;display:inline-block;background:#2230F6;border-radius:100px;line-height:24px;width:auto;text-align:center" }} target="_blank">Log In</a>
                        </span>
                    </td>
                </tr>
                </tbody>
...
module.exports = { getResetPasswordComponent }