...
const countWeightDiapasone = ({ height, gender }) => {
    const value = gender === 'female' ? height - 10 : height
    const lowerLimit = Number(18.5 * ((value * value) / 10000)).toFixed(0)
    const higherLimit = Number(25 * ((value * value) / 10000)).toFixed(0)
            ...
            if (currentStep.value === 'weight' && weight && weight >= min && weight <= max) {
                ...
                if (+desiredWeight < lowerLimit) {
                    ...
                    return {
                        ...
                        icon: currentStep.subTitles.gain.icon,
                        isOk: true
                    }
                } else if (+desiredWeight < +weight) {
                    ...
                    return {
                        ...
                        icon: currentStep.subTitles.looseNormal.icon,
                        isOk: true
                    }
                }
            }
