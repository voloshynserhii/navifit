                                        ...
                                        <tr style="border-collapse:collapse;">
                                            <td align="center" style="margin:0;padding-left:10px;padding-right:10px;padding-bottom:24px;">
                                                <span style="border-style:solid;border-width:0px;display:inline-block;width:auto">
                                                    <a href="${url}" style="text-decoration:none;color:#ffffff;font-size:14px;font-weight: 500;border-style:solid;border-color:#2230F6;border-width:8px 50px;display:inline-block;background:#2230F6;border-radius:100px;line-height:24px;width:auto;text-align:center" }} target="_blank">Log In</a>
                                                </span>
                                            </td>
                                        </tr>
                                    </td>
